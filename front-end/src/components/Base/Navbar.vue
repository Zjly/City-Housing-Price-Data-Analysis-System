          ...
          <ul v-if="sharedState.is_authenticated" class="nav navbar-nav navbar-right">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                ...
                <img v-bind:src="sharedState.user_avatar"
          ...
          if (window.localStorage.getItem('madblog-token')) {
            ...
            axios.get(path)
              .then((response) => {
                ...
                total_notifications_count = unread_recived_comments_count + unread_messages_count +
                  unread_follows_count + unread_posts_likes_count + unread_comments_likes_count +
                ...
                $('#new_notifications_count').css('visibility', total_notifications_count ? 'visible' :
                  'hidden');
              })
              .catch((error) => {
                // handle error
